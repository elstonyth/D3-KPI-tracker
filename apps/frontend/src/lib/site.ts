/**
 * Single source of truth for public brand/site constants — canonical URL,
 * domain, and contact emails used by the legal pages and metadata. Update here,
 * never per-page.
 *
...
export const PRIVACY_EMAIL = 'privacy@d3creator.com';
